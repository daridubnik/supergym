...
},{"./modules/form-validate/form":3,"./modules/init-slider-coaches":9,"./modules/init-video-player":10,"./modules/tabs/init-tabs":11,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
var initSliderCoaches = function initSliderCoaches() {
  ...
  new _swiper.default('.coaches__swiper', {
    navigation: {
...
var container = document.querySelector('.description__video-wrapper');
var cover = document.querySelector('.description__video-wrapper').querySelector('img');
var button = document.querySelector('.description__video-wrapper').querySelector('button');
